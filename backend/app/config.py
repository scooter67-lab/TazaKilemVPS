...
class Settings(BaseSettings):
    ...
    """
    Если true: при старте, если пароль admin не совпадает с admin123, хеш сбрасывается на admin123.
    Иначе пароль admin после смены в UI сохраняется между рестартами. Включайте один раз при потере доступа.
    """
